...
<template>
  <section class="rounded-[14px] border border-transparent bg-white/80 p-3.5 backdrop-blur-[14px] shadow-glass transition duration-200 hover:-translate-y-0.5 hover:shadow-[0_14px_20px_rgba(20,32,89,0.18)]">
    <div>
      <h3 class="m-0 text-[18px] font-bold text-slate-900">Manage Refund Requests</h3>
      <p class="mt-2 text-slate-600">Review request then approve or reject.</p>
    </div>

    <p v-if="!pendingRefunds.length" class="mt-3 text-slate-500">No pending refund requests.</p>
