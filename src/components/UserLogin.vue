  ...
  <div class="relative flex min-h-screen items-center justify-center bg-[radial-gradient(circle_at_top_left,rgba(217,220,219,0.9),transparent_26%),radial-gradient(circle_at_top_right,rgba(186,195,205,0.34),transparent_22%),linear-gradient(180deg,#f5f6f7_0%,#d9dcdb_34%,#bac3cd_66%,#2d3945_100%)] px-4 font-poppins">
    ...
    <div class="w-full max-w-[350px] rounded-xl bg-white p-[30px] shadow-[0_10px_25px_rgba(0,0,0,0.1)]">
      ...
      <form @submit.prevent="login">
        ...
        <button
          type="submit"
          class="mt-2 w-full rounded-md bg-[#2D3945] px-3 py-2.5 font-bold text-white transition-colors hover:bg-[#BAC3CD] hover:text-[#202833] focus-visible:bg-[#BAC3CD] focus-visible:text-[#202833] disabled:cursor-not-allowed disabled:opacity-85"
